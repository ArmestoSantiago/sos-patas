...
export function AnimalForm({ onCancel, onSubmit }: AnimalFormProps) {
  return (
    <div className="pb-20 my-6 mx-4">
      <form>
        ...
        <div className='bg-white rounded-3xl border border-stone-100 mt-6 p-6'>
          ...
          <div>
            ...
            <div>
              ...
              <button data-testid="location-button" type="button" className="w-full text-left rounded-xl border-2 transition-all bg-stone-50 border-stone-200 hover:border-[4CAF50] text-stone-400 py-3 px-4">
        ...
        <div className="flex gap-3 mt-6">
          <button type="button" data-testid="cancel-button" className="flex-1 bg-white border-2 border-stone-300 text-stone-600 rounded-full font-semibold hover:bf-stone-50 transition-colors py-3 px-4" >Cancelar</button>
          <button type="submit" data-testid="submit-button" className="flex-1 bg-[#2E7D32] text-white rounded-full font-semibold hover-[#1B5E20] transition-colors shadow-md py-3 px-4">Publicar</button>
        </div>
      </form >
    </div >
  );
